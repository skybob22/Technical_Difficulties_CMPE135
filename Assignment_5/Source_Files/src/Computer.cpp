 ...
 */
Computer* Computer::createComputer(ComputerDifficulty::Difficulty diff, int playerNum){
    switch (diff){
        case ComputerDifficulty::Difficulty::Easy:{
            return  new EasyComputer(playerNum);
        }
        case ComputerDifficulty::Difficulty::Hard:{
